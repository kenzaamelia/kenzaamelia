...
public class Listbarang extends javax.swing.JFrame {
    ...
    public void cari(){
        ...
        try {
            DB_Connection dbConn = new DB_Connection();
            Connection con = dbConn.getConnection();
            String sql = "Select * from barang where ID_Barang like '%" + cari.getText() + "%'" +
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LIST BARANG TOKO BESI");
    ...
    private void pilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pilihActionPerformed
        ...
        Penjual.idbarang.setText(id);
        Penjual.namabarang.setText(nama);
        Penjual.harga.setText(harga);
